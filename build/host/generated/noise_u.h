 ...
 */
#ifndef EDGER8R_NOISE_U_H
#define EDGER8R_NOISE_U_H

#include <openenclave/host.h>

#include "noise_args.h"
...
oe_result_t ecall_sharegen_batch(
    oe_enclave_t* enclave,
    int* _retval,
    uint64_t* round_ids,
    size_t batch_count,
...
oe_result_t ecall_store(
    oe_enclave_t* enclave,
    int* _retval,
    share_package_t* package,
    ack_message_t* ack);

oe_result_t ecall_store_batch(
    oe_enclave_t* enclave,
    int* _retval,
    share_package_t* packages,
    size_t batch_count,
...
oe_result_t ecall_done(
    oe_enclave_t* enclave,
    int* _retval,
    share_point_t* aggregate);

oe_result_t ecall_done_batch(
    oe_enclave_t* enclave,
    int* _retval,
