...
static const oe_ecall_info_t _noise_ecall_info_table[] = 
{
    { "ecall_init_party" },
    { "ecall_sharegen" },
...
oe_result_t noise_ecall_init_party(
    ...
    uint64_t threshold)
{
    ...
    /* Marshalling struct. */
    ecall_init_party_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    _args.party_id = party_id;
    _args.party_count = party_count;
    _args.threshold = threshold;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_init_party_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_init_party_args_t));
    /* There were no corresponding parameters. */
    ...
    _pargs_in = (ecall_init_party_args_t*)_input_buffer;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _noise_ecall_info_table[noise_fcn_id_ecall_init_party].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (ecall_init_party_args_t*)_output_buffer;
...
OE_WEAK_ALIAS(noise_ecall_init_party, ecall_init_party);

oe_result_t noise_ecall_sharegen(
    oe_enclave_t* enclave,
    int* _retval,
    uint64_t round_id,
    share_package_t* packages,
    ...
    uint64_t* sampled_secret)
{
    ...
    /* Marshalling struct. */
    ecall_sharegen_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.round_id = round_id;
    _args.packages = (share_package_t*)packages;
    _args.package_count = package_count;
    _args.sampled_secret = (uint64_t*)sampled_secret;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_sharegen_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_sharegen_args_t));
    if (packages)
        OE_ADD_ARG_SIZE(_output_buffer_size, _args.package_count, sizeof(share_package_t));
    if (sampled_secret)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_sharegen_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _noise_ecall_info_table[noise_fcn_id_ecall_sharegen].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_sharegen_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(packages, _args.package_count, sizeof(share_package_t));
    OE_READ_OUT_PARAM(sampled_secret, 1, sizeof(uint64_t));
...
OE_WEAK_ALIAS(noise_ecall_sharegen, ecall_sharegen);

oe_result_t noise_ecall_sharegen_batch(
    oe_enclave_t* enclave,
    int* _retval,
    uint64_t* round_ids,
    size_t batch_count,
    ...
    uint64_t* sampled_secrets)
{
    ...
    /* Marshalling struct. */
    ecall_sharegen_batch_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.round_ids = (uint64_t*)round_ids;
    _args.batch_count = batch_count;
    _args.packages = (share_package_t*)packages;
    _args.package_count = package_count;
    _args.sampled_secrets = (uint64_t*)sampled_secrets;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_sharegen_batch_args_t));
    if (round_ids)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.batch_count, sizeof(uint64_t));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_sharegen_batch_args_t));
    if (packages)
        OE_ADD_ARG_SIZE(_output_buffer_size, _args.package_count, sizeof(share_package_t));
    if (sampled_secrets)
        OE_ADD_ARG_SIZE(_output_buffer_size, _args.batch_count, sizeof(uint64_t));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_sharegen_batch_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (round_ids)
        OE_WRITE_IN_PARAM(round_ids, _args.batch_count, sizeof(uint64_t), uint64_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _noise_ecall_info_table[noise_fcn_id_ecall_sharegen_batch].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_sharegen_batch_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(packages, _args.package_count, sizeof(share_package_t));
    OE_READ_OUT_PARAM(sampled_secrets, _args.batch_count, sizeof(uint64_t));
...
OE_WEAK_ALIAS(noise_ecall_sharegen_batch, ecall_sharegen_batch);

oe_result_t noise_ecall_store(
    oe_enclave_t* enclave,
    int* _retval,
    share_package_t* package,
    ack_message_t* ack)
{
    ...
    /* Marshalling struct. */
    ecall_store_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.package = (share_package_t*)package;
    _args.ack = (ack_message_t*)ack;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_store_args_t));
    if (package)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, sizeof(share_package_t));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_store_args_t));
    if (ack)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(ack_message_t));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_store_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (package)
        OE_WRITE_IN_PARAM(package, 1, sizeof(share_package_t), share_package_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _noise_ecall_info_table[noise_fcn_id_ecall_store].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_store_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(ack, 1, sizeof(ack_message_t));
...
OE_WEAK_ALIAS(noise_ecall_store, ecall_store);

oe_result_t noise_ecall_store_batch(
    oe_enclave_t* enclave,
    int* _retval,
    share_package_t* packages,
    size_t batch_count,
    ack_message_t* acks)
{
    ...
    /* Marshalling struct. */
    ecall_store_batch_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    _args.packages = (share_package_t*)packages;
    _args.batch_count = batch_count;
    _args.acks = (ack_message_t*)acks;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_store_batch_args_t));
    if (packages)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.batch_count, sizeof(share_package_t));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_store_batch_args_t));
    if (acks)
        OE_ADD_ARG_SIZE(_output_buffer_size, _args.batch_count, sizeof(ack_message_t));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_store_batch_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (packages)
        OE_WRITE_IN_PARAM(packages, _args.batch_count, sizeof(share_package_t), share_package_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _noise_ecall_info_table[noise_fcn_id_ecall_store_batch].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_store_batch_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(acks, _args.batch_count, sizeof(ack_message_t));
...
OE_WEAK_ALIAS(noise_ecall_store_batch, ecall_store_batch);

oe_result_t noise_ecall_done(
    oe_enclave_t* enclave,
    int* _retval,
    share_point_t* aggregate)
{
    ...
    /* Marshalling struct. */
    ecall_done_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.aggregate = (share_point_t*)aggregate;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_done_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_done_args_t));
    if (aggregate)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(share_point_t));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_done_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _noise_ecall_info_table[noise_fcn_id_ecall_done].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_done_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(aggregate, 1, sizeof(share_point_t));
...
OE_WEAK_ALIAS(noise_ecall_done, ecall_done);

oe_result_t noise_ecall_done_batch(
    oe_enclave_t* enclave,
    int* _retval,
    share_point_t* aggregates,
    size_t batch_count)
{
    ...
    /* Marshalling struct. */
    ecall_done_batch_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.aggregates = (share_point_t*)aggregates;
    _args.batch_count = batch_count;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(ecall_done_batch_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(ecall_done_batch_args_t));
    if (aggregates)
        OE_ADD_ARG_SIZE(_output_buffer_size, _args.batch_count, sizeof(share_point_t));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (ecall_done_batch_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _noise_ecall_info_table[noise_fcn_id_ecall_done_batch].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (ecall_done_batch_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(aggregates, _args.batch_count, sizeof(share_point_t));
...
OE_WEAK_ALIAS(noise_ecall_done_batch, ecall_done_batch);

oe_result_t noise_oe_get_sgx_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _noise_ecall_info_table[noise_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(noise_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t noise_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    oe_report_buffer_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _noise_ecall_info_table[noise_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(noise_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t noise_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _noise_ecall_info_table[noise_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(noise_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t noise_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _noise_ecall_info_table[noise_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(noise_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t noise_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _noise_ecall_info_table[noise_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(noise_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);
...
static oe_ocall_func_t _noise_ocall_function_table[] = {
...
oe_result_t oe_create_noise_enclave(
    const char* path,
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               _noise_ocall_function_table,
               87,
               _noise_ecall_info_table,
                12,
               enclave);
}
