 ...
 */
#ifndef EDGER8R_NOISE_ARGS_H
#define EDGER8R_NOISE_ARGS_H
...
#ifndef EDGER8R_STRUCT_SHARE_PACKAGE_T
#define EDGER8R_STRUCT_SHARE_PACKAGE_T
typedef struct share_package_t
{
    uint64_t round_id;
    uint64_t sender_id;
...
#ifndef EDGER8R_STRUCT_ACK_MESSAGE_T
#define EDGER8R_STRUCT_ACK_MESSAGE_T
typedef struct ack_message_t
{
    uint64_t round_id;
...
#ifndef EDGER8R_STRUCT_SHARE_POINT_T
#define EDGER8R_STRUCT_SHARE_POINT_T
typedef struct share_point_t
{
    uint64_t x;
    uint64_t y;
} share_point_t;
