 ...
 */
#ifndef EDGER8R_NOISE_T_H
#define EDGER8R_NOISE_T_H
...
int ecall_store_batch(
    share_package_t* packages,
    size_t batch_count,
    ack_message_t* acks);

int ecall_done(share_point_t* aggregate);

int ecall_done_batch(
