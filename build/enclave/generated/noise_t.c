...
enum
{
    noise_fcn_id_ecall_init_party = 0,
    noise_fcn_id_ecall_sharegen = 1,
    noise_fcn_id_ecall_sharegen_batch = 2,
    noise_fcn_id_ecall_store = 3,
    noise_fcn_id_ecall_store_batch = 4,
    noise_fcn_id_ecall_done = 5,
    noise_fcn_id_ecall_done_batch = 6,
    noise_fcn_id_oe_get_sgx_report_ecall = 7,
    noise_fcn_id_oe_get_report_v2_ecall = 8,
    noise_fcn_id_oe_verify_local_report_ecall = 9,
    noise_fcn_id_oe_sgx_init_context_switchless_ecall = 10,
    noise_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 11,
    noise_fcn_id_trusted_call_id_max = OE_ENUM_MAX
};

/**** ECALL marshalling structs. ****/
typedef struct _ecall_init_party_args_t
{
    ...
    uint64_t threshold;
} ecall_init_party_args_t;

typedef struct _ecall_sharegen_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
} ecall_sharegen_args_t;

typedef struct _ecall_sharegen_batch_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
} ecall_sharegen_batch_args_t;

typedef struct _ecall_store_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
typedef struct _ecall_store_batch_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    size_t batch_count;
    ack_message_t* acks;
} ecall_store_batch_args_t;

typedef struct _ecall_done_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    int oe_retval;
    share_point_t* aggregate;
} ecall_done_args_t;

typedef struct _ecall_done_batch_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    int oe_retval;
    share_point_t* aggregates;
    size_t batch_count;
} ecall_done_batch_args_t;
...
static void ecall_ecall_init_party(
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ecall_init_party_args_t* _pargs_in = (ecall_init_party_args_t*)input_buffer;
    ecall_init_party_args_t* _pargs_out = (ecall_init_party_args_t*)output_buffer;
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ecall_init_party(
        _pargs_in->party_id,
        _pargs_in->party_count,
        _pargs_in->threshold);
...
static void ecall_ecall_sharegen(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ecall_sharegen_args_t* _pargs_in = (ecall_sharegen_args_t*)input_buffer;
    ecall_sharegen_args_t* _pargs_out = (ecall_sharegen_args_t*)output_buffer;
    ...
    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->packages)
        OE_SET_OUT_POINTER(packages, _pargs_in->package_count, sizeof(share_package_t), share_package_t*);
    if (_pargs_in->sampled_secret)
        OE_SET_OUT_POINTER(sampled_secret, 1, sizeof(uint64_t), uint64_t*);
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ecall_sharegen(
        _pargs_in->round_id,
        _pargs_in->packages,
        _pargs_in->package_count,
        _pargs_in->sampled_secret);
...
static void ecall_ecall_sharegen_batch(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ecall_sharegen_batch_args_t* _pargs_in = (ecall_sharegen_batch_args_t*)input_buffer;
    ecall_sharegen_batch_args_t* _pargs_out = (ecall_sharegen_batch_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->round_ids)
        OE_SET_IN_POINTER(round_ids, _pargs_in->batch_count, sizeof(uint64_t), uint64_t*);

    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->packages)
        OE_SET_OUT_POINTER(packages, _pargs_in->package_count, sizeof(share_package_t), share_package_t*);
    if (_pargs_in->sampled_secrets)
        OE_SET_OUT_POINTER(sampled_secrets, _pargs_in->batch_count, sizeof(uint64_t), uint64_t*);
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ecall_sharegen_batch(
        _pargs_in->round_ids,
        _pargs_in->batch_count,
        _pargs_in->packages,
        _pargs_in->package_count,
        _pargs_in->sampled_secrets);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ecall_store_args_t* _pargs_in = (ecall_store_args_t*)input_buffer;
    ecall_store_args_t* _pargs_out = (ecall_store_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->package)
        OE_SET_IN_POINTER(package, 1, sizeof(share_package_t), share_package_t*);

    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->ack)
        OE_SET_OUT_POINTER(ack, 1, sizeof(ack_message_t), ack_message_t*);
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ecall_store(
        _pargs_in->package,
        _pargs_in->ack);
...
static void ecall_ecall_store_batch(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ecall_store_batch_args_t* _pargs_in = (ecall_store_batch_args_t*)input_buffer;
    ecall_store_batch_args_t* _pargs_out = (ecall_store_batch_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->packages)
        OE_SET_IN_POINTER(packages, _pargs_in->batch_count, sizeof(share_package_t), share_package_t*);

    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->acks)
        OE_SET_OUT_POINTER(acks, _pargs_in->batch_count, sizeof(ack_message_t), ack_message_t*);
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ecall_store_batch(
        _pargs_in->packages,
        _pargs_in->batch_count,
        _pargs_in->acks);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ecall_done_args_t* _pargs_in = (ecall_done_args_t*)input_buffer;
    ecall_done_args_t* _pargs_out = (ecall_done_args_t*)output_buffer;
    ...
    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->aggregate)
        OE_SET_OUT_POINTER(aggregate, 1, sizeof(share_point_t), share_point_t*);
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ecall_done(
        _pargs_in->aggregate);
...
static void ecall_ecall_done_batch(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    ecall_done_batch_args_t* _pargs_in = (ecall_done_batch_args_t*)input_buffer;
    ecall_done_batch_args_t* _pargs_out = (ecall_done_batch_args_t*)output_buffer;
    ...
    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->aggregates)
        OE_SET_OUT_POINTER(aggregates, _pargs_in->batch_count, sizeof(share_point_t), share_point_t*);
    ...
    /* Call user function. */
    _pargs_out->oe_retval = ecall_done_batch(
        _pargs_in->aggregates,
        _pargs_in->batch_count);
...
oe_ecall_func_t oe_ecalls_table[] = {
    (oe_ecall_func_t) ecall_ecall_init_party,
    (oe_ecall_func_t) ecall_ecall_sharegen,
    (oe_ecall_func_t) ecall_ecall_sharegen_batch,
    (oe_ecall_func_t) ecall_ecall_store,
    (oe_ecall_func_t) ecall_ecall_store_batch,
    (oe_ecall_func_t) ecall_ecall_done,
    (oe_ecall_func_t) ecall_ecall_done_batch,
...
enum
{
    noise_fcn_id_oe_syscall_epoll_create1_ocall = 0,
    noise_fcn_id_oe_syscall_epoll_wait_ocall = 1,
    noise_fcn_id_oe_syscall_epoll_wake_ocall = 2,
    noise_fcn_id_oe_syscall_epoll_ctl_ocall = 3,
    noise_fcn_id_oe_syscall_epoll_close_ocall = 4,
    noise_fcn_id_oe_syscall_open_ocall = 5,
    noise_fcn_id_oe_syscall_read_ocall = 6,
    noise_fcn_id_oe_syscall_write_ocall = 7,
    noise_fcn_id_oe_syscall_readv_ocall = 8,
    noise_fcn_id_oe_syscall_writev_ocall = 9,
    noise_fcn_id_oe_syscall_lseek_ocall = 10,
    noise_fcn_id_oe_syscall_pread_ocall = 11,
    noise_fcn_id_oe_syscall_pwrite_ocall = 12,
    noise_fcn_id_oe_syscall_close_ocall = 13,
    noise_fcn_id_oe_syscall_flock_ocall = 14,
    noise_fcn_id_oe_syscall_fsync_ocall = 15,
    noise_fcn_id_oe_syscall_fdatasync_ocall = 16,
    noise_fcn_id_oe_syscall_dup_ocall = 17,
    noise_fcn_id_oe_syscall_opendir_ocall = 18,
    noise_fcn_id_oe_syscall_readdir_ocall = 19,
    noise_fcn_id_oe_syscall_rewinddir_ocall = 20,
    noise_fcn_id_oe_syscall_closedir_ocall = 21,
    noise_fcn_id_oe_syscall_stat_ocall = 22,
    noise_fcn_id_oe_syscall_fstat_ocall = 23,
    noise_fcn_id_oe_syscall_access_ocall = 24,
    noise_fcn_id_oe_syscall_link_ocall = 25,
    noise_fcn_id_oe_syscall_unlink_ocall = 26,
    noise_fcn_id_oe_syscall_rename_ocall = 27,
    noise_fcn_id_oe_syscall_truncate_ocall = 28,
    noise_fcn_id_oe_syscall_ftruncate_ocall = 29,
    noise_fcn_id_oe_syscall_mkdir_ocall = 30,
    noise_fcn_id_oe_syscall_rmdir_ocall = 31,
    noise_fcn_id_oe_syscall_fcntl_ocall = 32,
    noise_fcn_id_oe_syscall_ioctl_ocall = 33,
    noise_fcn_id_oe_syscall_poll_ocall = 34,
    noise_fcn_id_oe_syscall_kill_ocall = 35,
    noise_fcn_id_oe_syscall_close_socket_ocall = 36,
    noise_fcn_id_oe_syscall_socket_ocall = 37,
    noise_fcn_id_oe_syscall_shutdown_sockets_device_ocall = 38,
    noise_fcn_id_oe_syscall_socketpair_ocall = 39,
    noise_fcn_id_oe_syscall_connect_ocall = 40,
    noise_fcn_id_oe_syscall_accept_ocall = 41,
    noise_fcn_id_oe_syscall_bind_ocall = 42,
    noise_fcn_id_oe_syscall_listen_ocall = 43,
    noise_fcn_id_oe_syscall_recvmsg_ocall = 44,
    noise_fcn_id_oe_syscall_sendmsg_ocall = 45,
    noise_fcn_id_oe_syscall_recv_ocall = 46,
    noise_fcn_id_oe_syscall_recvfrom_ocall = 47,
    noise_fcn_id_oe_syscall_send_ocall = 48,
    noise_fcn_id_oe_syscall_sendto_ocall = 49,
    noise_fcn_id_oe_syscall_recvv_ocall = 50,
    noise_fcn_id_oe_syscall_sendv_ocall = 51,
    noise_fcn_id_oe_syscall_shutdown_ocall = 52,
    noise_fcn_id_oe_syscall_setsockopt_ocall = 53,
    noise_fcn_id_oe_syscall_getsockopt_ocall = 54,
    noise_fcn_id_oe_syscall_getsockname_ocall = 55,
    noise_fcn_id_oe_syscall_getpeername_ocall = 56,
    noise_fcn_id_oe_syscall_getaddrinfo_open_ocall = 57,
    noise_fcn_id_oe_syscall_getaddrinfo_read_ocall = 58,
    noise_fcn_id_oe_syscall_getaddrinfo_close_ocall = 59,
    noise_fcn_id_oe_syscall_getnameinfo_ocall = 60,
    noise_fcn_id_oe_syscall_nanosleep_ocall = 61,
    noise_fcn_id_oe_syscall_clock_nanosleep_ocall = 62,
    noise_fcn_id_oe_syscall_getpid_ocall = 63,
    noise_fcn_id_oe_syscall_getppid_ocall = 64,
    noise_fcn_id_oe_syscall_getpgrp_ocall = 65,
    noise_fcn_id_oe_syscall_getuid_ocall = 66,
    noise_fcn_id_oe_syscall_geteuid_ocall = 67,
    noise_fcn_id_oe_syscall_getgid_ocall = 68,
    noise_fcn_id_oe_syscall_getegid_ocall = 69,
    noise_fcn_id_oe_syscall_getpgid_ocall = 70,
    noise_fcn_id_oe_syscall_getgroups_ocall = 71,
    noise_fcn_id_oe_syscall_uname_ocall = 72,
    noise_fcn_id_oe_get_supported_attester_format_ids_ocall = 73,
    noise_fcn_id_oe_get_qetarget_info_ocall = 74,
    noise_fcn_id_oe_get_quote_ocall = 75,
    noise_fcn_id_oe_get_quote_verification_collateral_ocall = 76,
    noise_fcn_id_oe_get_quote_verification_collateral_with_baseline_ocall = 77,
    noise_fcn_id_oe_verify_quote_ocall = 78,
    noise_fcn_id_oe_sgx_get_cpuid_table_ocall = 79,
    noise_fcn_id_oe_sgx_backtrace_symbols_ocall = 80,
    noise_fcn_id_oe_sgx_log_backtrace_ocall = 81,
    noise_fcn_id_oe_sgx_thread_wake_wait_ocall = 82,
    noise_fcn_id_oe_sgx_wake_switchless_worker_ocall = 83,
    noise_fcn_id_oe_sgx_sleep_switchless_worker_ocall = 84,
    noise_fcn_id_oe_get_tdx_quote_verification_collateral_ocall = 85,
    noise_fcn_id_oe_verify_tdx_quote_ocall = 86,
    noise_fcn_id_untrusted_call_max = OE_ENUM_MAX
};
    ...
    int flags)
{
    ...
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_epoll_create1_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int timeout)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_epoll_wait_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_epoll_wake_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_epoll_wake_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_epoll_event* event)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_epoll_ctl_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t epfd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_epoll_close_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_mode_t mode)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_open_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t count)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_read_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t count)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_write_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_readv_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_writev_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int whence)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_lseek_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t offset)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_pread_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t offset)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_pwrite_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t fd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_close_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int operation)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_flock_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t fd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_fsync_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t fd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_fdatasync_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t oldfd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_dup_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* name)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_opendir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_dirent* entry)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_readdir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_rewinddir_ocall(uint64_t dirp)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_rewinddir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t dirp)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_closedir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_stat_t* buf)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_stat_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_stat_t* buf)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_fstat_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int mode)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_access_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* newpath)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_link_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* pathname)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_unlink_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* newpath)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_rename_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t length)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_truncate_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_off_t length)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_ftruncate_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_mode_t mode)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_mkdir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    const char* pathname)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_rmdir_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    void* argout)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_fcntl_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    void* argout)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_ioctl_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int timeout)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_poll_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int signum)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_kill_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t sockfd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_close_socket_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int protocol)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_socket_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t sockfd)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_shutdown_sockets_device_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_host_fd_t sv[2])
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_socketpair_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t addrlen)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_connect_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_accept_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t addrlen)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_bind_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int backlog)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_listen_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_recvmsg_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_sendmsg_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_recv_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_recvfrom_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_send_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t addrlen)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_sendto_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_recvv_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t iov_buf_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_sendv_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int how)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_shutdown_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t optlen)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_setsockopt_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* optlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_getsockopt_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_getsockname_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    oe_socklen_t* addrlen_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_getpeername_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t* handle)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_getaddrinfo_open_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    char* ai_canonname)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_getaddrinfo_read_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t handle)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_getaddrinfo_close_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int flags)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_getnameinfo_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_timespec* rem)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_nanosleep_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_timespec* rem)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_clock_nanosleep_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getpid_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_getpid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getppid_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_getppid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getpgrp_ocall(int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_getpgrp_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getuid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_getuid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_geteuid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_geteuid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getgid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_getgid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_syscall_getegid_ocall(unsigned int* _retval)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_getegid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    int pid)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_getpgid_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    unsigned int* list)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_getgroups_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    struct oe_utsname* buf)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_syscall_uname_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    format_ids_t* format_ids)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_get_supported_attester_format_ids_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    sgx_target_info_t* target_info)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_get_qetarget_info_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* quote_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_get_quote_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* qe_identity_issuer_chain_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_get_quote_verification_collateral_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* qe_identity_issuer_chain_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_get_quote_verification_collateral_with_baseline_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint32_t qe_identity_issuer_chain_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_verify_quote_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t cpuid_table_buffer_size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_sgx_get_cpuid_table_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t* symbols_buffer_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_sgx_backtrace_symbols_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    size_t size)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_sgx_log_backtrace_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint64_t self_tcs)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_sgx_thread_wake_wait_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_sgx_wake_switchless_worker_ocall(oe_host_worker_context_t* context)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_sgx_wake_switchless_worker_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
oe_result_t oe_sgx_sleep_switchless_worker_ocall(oe_enclave_worker_context_t* context)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_sgx_sleep_switchless_worker_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    tdx_quote_collateral_t* collateral)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_get_tdx_quote_verification_collateral_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    uint32_t* p_supplemental_data_size_out)
{
    ...
    /* Call host function. */
    if ((_result = oe_call_host_function(
             noise_fcn_id_oe_verify_tdx_quote_ocall,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
